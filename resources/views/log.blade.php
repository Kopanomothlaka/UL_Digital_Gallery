            ...
            <div class="card border-0 shadow">
              ...
              <img src="/img/logo.png" alt="" class="img-fluid">
                ...
                <label for="username">Email</label>
                  <input type="email" name="email" id="" class="form-control rounded-pill my-1 py-2 custom-input"  />

                  <label for="username">Password</label>
                  <input type="password" name="password" id="" class="form-control rounded-pill my-1 py-2 custom-input"  />
